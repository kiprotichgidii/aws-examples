...
**AWS Services**
- [Amazon S3](https://github.com/kiprotichgidii/aws-examples/blob/main/s3/README.md#amazon-simple-storage-services3)
- [AWS VPC](https://github.com/kiprotichgidii/aws-examples/blob/main/vpc/README.md#aws-virtual-private-cloud-vpc)
- [AWS IAM](https://github.com/kiprotichgidii/aws-examples/blob/main/iam/README.md#aws-identity-and-access-management-iam)
- [Amazon EC2](https://github.com/kiprotichgidii/aws-examples/blob/main/ec2/README.md#amazon-elastic-compute-cloud-ec2)
- [Amazon ASG](https://github.com/kiprotichgidii/aws-examples/blob/main/asg/README.md#auto-scaling-group-asg)
- [AWS Route 53](https://github.com/kiprotichgidii/aws-examples/blob/main/asg/README.md#aws-route-53)
- [Amazon ELB](https://github.com/kiprotichgidii/aws-examples/blob/main/asg/README.md#elastic-load-balancer-elb)
...
- [Amazon EBS](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-elastic-block-store-ebs)
- [Amazon EFS](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-elastic-file-system-efs)
- [Amazon FSx](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-fsx)
- [AWS Backup](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-backup)
- [AWS Snow Family](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-snow-family)
- [AWS Transfer Family](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#transfer-family-managed-file-transfer-workflows)
- [AWS Migration Hub](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-migration-hub)
- [AWS DataSync](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-datasync)
- [AWS DMS](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#database-migration-service-dms)
- [AWS Auto Scaling](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-auto-scaling)
- [AWS Amplify](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-amplify)
- [Amazon AppFlow](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-appflow)
- [AWS AppSync](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-appsync)
- [AWS Batch](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-batch)
- [Amazon OpenSearch Service](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-opensearch-service)
- [AWS Device Farm](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-device-farm)
- [Amazon Quantum Ledger Database](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-quantum-ledger-database)
- [AWS Elastic Transcoder](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-elastic-transcoder)
- [AWS MediaConvert](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#aws-elemental-mediaconvert)
- [Amazon SNS](https://github.com/kiprotichgidii/aws-examples/blob/main/bundled/README.md#amazon-simple-notification-service-sns)
- [Amazon SQS](https://github.com/kiprotichgidii/aws-examples/tree/main/sqs#amazon-simple-queueing-service-sqs)
...
- [Amazon DocumentDB](https://github.com/kiprotichgidii/aws-examples/blob/main/rds/README.md#amazon-documentdb)
- [Amazon DynamoDB](https://github.com/kiprotichgidii/aws-examples/blob/main/rds/README.md#amazon-dynamodb)
...
- [Amazon GuardDuty](https://github.com/kiprotichgidii/aws-examples/blob/main/shield-waf/README.md#amazon-guard-duty)
...
---
*FYI I got a 799 on my first attempt at the AWS Certified Solutions Architect - Associate exam...* 